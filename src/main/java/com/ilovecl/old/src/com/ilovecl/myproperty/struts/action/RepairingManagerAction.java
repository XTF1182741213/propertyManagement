...
public class RepairingManagerAction extends ActionSupport {
    ...
    /**
     * @param sumitDateStr the sumitDateStr to set
     */
    ...
    /**
     * @param toRepairDateString the toRepairDateString to set
     */
    ...
    /**
     * @param isFinishRepairString the isFinishRepairString to set
     */
    ...
    /**
     * @param repairerName the repairerName to set
     */
