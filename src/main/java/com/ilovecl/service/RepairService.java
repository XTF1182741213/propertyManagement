...
public interface RepairService {
     ...
     * @return 提交是否成功
     */
    boolean submitRepair(String detail, String place, String picMD5, int studentId);
     ...
     * @return 提交的报修单的列表
     */
    List<Repair> getRepqirByStudentId(int studentId);
     ...
     * @return 待取消报修单
     */
    List<Repair> getAllToBeCanceledById(int studentId);
