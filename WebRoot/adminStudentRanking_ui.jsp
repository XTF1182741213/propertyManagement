										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="94%" valign="bottom"><span class="STYLE1"><font
														color="#010E21" size='3'>学生提交报修单排行榜</font></span></td>
											</tr>
										</table>
									</td>
									<td>
				...
				<form action="repairOrder_un_delete" method="get" id="formsubmit">
					<table id="infomation" width="100%" border="0" cellpadding="0"
						...
						<tr>
							...
							<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">提交报修单数量</span>
								</div></td>
							<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">第一次提交报修单时间</span>
								</div></td>
							<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">最近一次提交报修单时间</span>
								</div></td>
							<td width="15%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">受处理报修单数量</span>
								</div></td>
							...
							<tr>
								...
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										...
										<span class="STYLE10"><s:property
												value="name"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="num"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="firstSubmitDateStr"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="lastSubmitDateStr"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property
												value="repairedNum"></s:property></span>
									</div></td>
