										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="94%" valign="bottom"><span class="STYLE1"><font
														color="#010E21" size='3'>检修安排管理</font></span></td>
											</tr>
										</table>
									</td>
									<td>
									...
									<td>
										<div align="left">
											<span class="STYLE1"> &nbsp;&nbsp; <img
												...
												type="button" id="delete" value="撤销检修" /> &nbsp;
				...
				<form action="repairOrder_un_delete" method="get" id="formsubmit">
					<table id="infomation" width="100%" border="0" cellpadding="0"
						...
						<tr>
							...
							<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">维修安排时间</span>
								</div></td>
							<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">是否维修完毕</span>
								</div></td>
							<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
							...
							<td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">维修人员编号</span>
								</div></td>
							<td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div
									align="center">
									<span class="STYLE10">维修人员</span>
								</div></td>
						</tr>
						<s:iterator value="getdate">
							<tr>
								...
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="sumitDateStr"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="toRepairDateStr"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="isFinishRepair"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property
								...
								<td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="repairerId"></s:property></span>
									</div></td>
								<td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="repairerName"></s:property></span>
									</div></td>
							</tr>
						</s:iterator>
