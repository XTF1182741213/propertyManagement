...
<body>
	<table width="100%" border="0" align="center" cellpadding="0"
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="94%" valign="bottom"><span class="STYLE1"><font
														color="#010E21" size='3'>待取消的报修单</font></span></td>
											</tr>
										</table>
									</td>
									<td>
									...
									<td>
										<div align="left">
											<span class="STYLE1"> &nbsp;&nbsp; <img
												...
												type="button" id="delete" value="同意取消" /> &nbsp;&nbsp;
												&nbsp;&nbsp;<img src="images/tabedit.gif" width="10"
												height="10" /><input type="button" id="edit" value="拒绝取消" />
												&nbsp;
		...
		<tr>
			<td>
				<form action="repairOrder_delete" method="get" id="formsubmit">
