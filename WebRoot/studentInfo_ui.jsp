										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="94%" valign="bottom"><span class="STYLE1"><font
														color="#010E21" size='3'>个人信息管理</font></span></td>
											</tr>
										</table>
									</td>
									<td>
									...
									<td>
										<div align="left">
											<span class="STYLE1"> &nbsp;&nbsp; <img
												...
												type="button" id="delete" value="修改密码" /> &nbsp;&nbsp;
												&nbsp;&nbsp;<img src="images/tabedit.gif" width="10"
												height="10" /><input type="button" id="edit" value="修改资料" />
												&nbsp;
					...
					<table id="infomation" width="100%" border="0" cellpadding="0"
						...
						<s:iterator value="getdate">
							<tr>
								...
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="userId"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property
												value="userName"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="phoneNumber"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="email"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="sexual"></s:property></span>
									</div></td>
