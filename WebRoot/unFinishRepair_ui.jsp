										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="94%" valign="bottom"><span class="STYLE1"><font
														color="#010E21" size='3'>未完成报修单信息</font></span></td>
											</tr>
										</table>
									</td>
									<td>
									...
									<td>
										<div align="left">
											<span class="STYLE1"> &nbsp;&nbsp; <img
												...
												type="button" id="delete" value="取消" /> &nbsp;&nbsp; &nbsp;
					...
					<table id="infomation" width="100%" border="0" cellpadding="0"
						...
						<s:iterator value="getdate">
							<tr>
								...
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="problemDescription"></s:property></span>
									</div></td>
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
								...
								<td width="10%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
										<span class="STYLE10"><s:property value="order_status_str"></s:property></span>
									</div></td>
								<td width="20%" height="20" bgcolor="d3eaef" class="STYLE6"><div
										align="center">
